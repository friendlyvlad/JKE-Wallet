...
public class CustomerForm extends AbstractForm<Customer> {
    ...
    TextField username = new MTextField("Username").withFullWidth();
    ...
    TypedSelect<CustomerStatus> status = new TypedSelect().withCaption("Status");
    ...
    protected Component createContent() {
        ...
        return new MVerticalLayout(
                new Header("Edit customer name").setHeaderLevel(3),
                new MFormLayout(
                        firstName,
                        lastName,
                        username,
